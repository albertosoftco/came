...
namespace Came.Modelo.Interface
{
    ...
    public interface IModelo
    {
        ...
        /// </summary>
        /// <returns></returns>
        DbSet<Actividad_Ejercicio> GetRelacionesActividadEjercicio();
        ...
        /// </summary>
        /// <returns></returns>
        DbSet<Grupo_Alumno> GetRelacionesGrupoAlumno();

        /// <summary>
        /// 
        /// </summary>
        /// <returns></returns>
        DbSet<Maestro_Grupo> GetRelacionesMaestroGrupo();

        /// <summary>
        /// 
        /// </summary>
        /// <returns></returns>
        DbSet<Programa_Actividad> GetRelacionesProgramaActividad();

        /// <summary>
        /// 
        /// </summary>
        /// <returns></returns>
        DbSet<Rutina_Programa> GetRelacionesRutinaPrograma();
    }
}
